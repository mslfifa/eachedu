...
<div class="admin">
    ...
    <div class="clearfix text-center">
    	<a class="button button-big bg-main badge-corner" href="http://demo.pintuer.com/pintuer3/" target="_blank">拼图最美中文后台-后翘<span class="badge bg-red">会员</span></a>
        <br /><br />
        <a href="http://demo.pintuer.com/pintuer3/" target="_blank"><img src="images/index.jpg" class="img-responsive" alt="会员版-登录" /></a><br />
        <a href="http://demo.pintuer.com/pintuer3/login.html" target="_blank"><img src="images/login.jpg" class="img-responsive" alt="会员版-首页" /></a>
    </div>
    <br />
</div>
