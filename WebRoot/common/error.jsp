...
.error-page-main:before{content:'';display:block;background:url(imgages/errorPageBorder.png);height:7px;position:absolute;top:-7px;width:100%;left:0}
    ...
    <div class="error-page-container">
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                <div>
                    <h4>原因：</h4>
                    <p><font color="red"><strong> <c:if test="${!empty errMsg }"><c:out name="errMsg"></c:out></c:if>  </strong></font></p>
                </div>
                <div>
                    <h4>可以尝试：</h4>
                    <ul>
                        <li><a href="<%=basePath %>login.jsp">返回首页</a></li>
                    </ul>
                </div>
            </div>
        </div>
