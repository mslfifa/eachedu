...
public class WXPrepay {
	...
	/****预支付订单号请求报文**/
	public static ThreadLocal<String>  prePayReqMsg=new ThreadLocal<String>();
	/****预支付订单号响应报文**/
	public static ThreadLocal<String>  prePayRspMsg=new ThreadLocal<String>();
